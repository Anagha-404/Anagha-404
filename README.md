...
CS Engineering student at MBCET, Trivandrum. I like building things that work on messy real-world data — not just clean demos.

Currently into: LLM integration, graph neural networks, and OCR pipelines.
...
`Python` `JavaScript` `Flask` `MERN` `PyTorch Geometric` `Neo4j` `OpenCV` `Gemini API`

---

## Experience

3 internships across Technopark and Keltron — Flask, MERN, Django.

---

[LinkedIn](https://www.linkedin.com/in/anagha-asok-kumar) · anaghas0k2005@gmail.com
